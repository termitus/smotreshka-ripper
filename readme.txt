...
Последняя правка:
1. Удаляются номера каналов перед названием;
2. В режиме selectmax убрано качество в скобках;
Вобщем все направлено на то, чтоб название канала не содержало ничего лишнего
